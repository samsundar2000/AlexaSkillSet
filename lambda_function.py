...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Welcome! Feel free to ask any details regarding COVID-19 I am here to help you, May i know your name, location and temperature please?"
...
class HelloWorldIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speak_output = "Hello Human! I am a good friend of you, you can talk to me when you feel bored" 
...
class addInfo(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        url = "https://2y3co6lxj4.execute-api.us-east-1.amazonaws.com/guided?Names="+str(person_name_value)+"&Location="+str(person_location_value)+"&Temparature="+str(temparature_value)
        response = requests.get(url)
...
class QuestionAlexaHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        speak_output=" Ask any questions or recommandations regarding COVID-19 i would help you!."
...
class MildConditionHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speak_output="Hey! It's nothing to worry ,just social distance yourself and wear mask whenever nescessary "
...
class SevereConditionHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speak_output="Hey There! The symptoms seems  severe here, you must quarantine yourself for 16 days in order to be safe for the people around you as it could spread"
...
class CatchAllExceptionHandler(AbstractExceptionHandler):
    ...
    def handle(self, handler_input, exception):
        ...
        speak_output = "Sorry, I couldn't hear you, can you repeat again?."
